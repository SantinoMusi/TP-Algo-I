...
\Tipo{Bool}
    ...
    \\ edr_1.sospechosos = edr_2.sospechosos)
    }
\end{proc}
...
\Tipo{}
    ...
    \requiereLargo{ 
        ...
        (enRango(a1.coord, a2.coord, edr.aula) \land\\
        suExamen(a1.coord, edr.aula)[i] = "" \land\\
        suExamen(a2.coord, edr.aula)[i] \neq "")}}\yLuego
        (edr_0 = edr)
    }
    \aseguraLargo{
        \existe{j}{\Z}{0\leq j < \norm{a1.examen}\yLuego \existe{a3}{alumno}{\\
            perteneceAlumno(a3, edr_0.aula) \yLuego \\
            (enRango(a1.coord, a3.coord, edr_0.aula)\land\\
            suExamen(a1.coord, edr_0.aula)[j]= "" \land \\
            suExamen(a3.coord, edr_0.aula)[j] \neq "" \land\\
            suExamen(a1.coord, edr.aula)[j] = suExamen(a3.coord, edr.aula)[j]\land\\
            mismosEjerciciosMenos(j, suExamen(a1.coord, edr.aula), a1.examen))\\
        }}\yLuego\\
        ...
        \\ (edr_0.sospechosos = edr.sospechosos) \yLuego
    } 
\end{proc}
\\
...
\Inout edr: EdR
    ...
    \\edr.sospechosos = edr_0.sospechosos \yLuego
}
\end{proc}
...
\Tipo{\seq{Alumno}}
    ...
    \aseguraLargo{
        ...
        \\ \norm{edr.sospechosos} = \norm{res} \yLuego
        \\ \paraTodo{a3}{Alumno}{a3 \in edr.sospechosos \leftrightarrow a3 \in res}
        }
\end{proc}
...
\Tipo{\seq{tupla\tupla{Alumno, Nota}}}
    ...
    \aseguraLargo{
        ...
        \paraTodo{a}{Alumno}{(a \in edr.entregas \land \lnot (a \in edr.sospechosos)) \leftrightarrow\\
        ...
        % con el existencial es necesario chequear el rango en el que es valido???
}
\end{proc}
