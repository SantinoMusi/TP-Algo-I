...
\predLargo{examenesInicializados}{a: Aula, sol: Examen}{
    \paraTodo{c}{Coordenada}{c\in a \implicaLuego examenInicializado(a[c], sol)}
}
...
\predLargo{todosEstudiantesIgualesMenos}{coords: \seq{Coordenada}, a0, a1: Aula}{
        ...
        \paraTodo{c}{Coordenada}{(c \in a0 \land \neg(c \in coords)) \implicaLuego a1[c] = a0[c]}
}
...
\predLargo{perteneceAlumno}{e: Alumno, a:Aula}{
    (e.coord \in a \land suExamen(e.cord, a) = e.examen)
}
...
\Tipo{\seq{Examen}}
    ...
    \aseguraLargo{
        ...
        edr.aula = setKey(edr_0.aula, a.coord, res[\norm{res}-1]) \land\\
        edr_0.solucion = edr.solucion \land\\
        edr_0.entregas = edr.entregas
    }
\end{proc}
...
\Inout edr: EdR
    ...
    \aseguraLargo{
        ...
        \\ edr.aula = delKey(edr_0.aula, a.coord) \land
