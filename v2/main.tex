...
\Tipo{}
    ...
    \requiereLargo{ 
        ...
        \\ edr = edr0 \yLuego
        \\ alumno.cordenadas.x = x0 \yLuego
        \\ alumno.cordenadas.y = y0 \yLuego
    ...
    \aseguraLargo{(\exists i, j: \Z)(cordenadasValidas(i, j, edr.Aula) \yLuego 
    \\ adyacente(<i, j>, alumno.cordenadas) \yLuego
    ...
    \\ \paraTodo p \Z{\paraTodo q \Z{cordenadasValidas(p,q, edr0.Aula) \yLuego
    \\ (x0 \neq p \land y0 \neq q) \implicaLuego edr.Aula[p][q] = edr0.Aula[p][q]}} \yLuego
    \\ edr0.solucion = edr.solucion \yLuego % el resto esta igual
