...
\Tipo{EdR}
    ...
    \\ \paraTodo{i}{\Z}{\paraTodo{j}{\Z}{((0 \leq i < dimensionAula \land 0 \leq j < dimensionAula) \yLuego edr.aula[i][j] \neq \langle \rangle) \implicaLuego \\((edr.aula[i][j].coord.f = i \land edr.aula[i][j].coord.c = j))}} \yLuego
