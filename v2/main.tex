...
\Tipo{}
    ...
    \requiereLargo{ 
        (\norm{edr.Aula[alumno.f][alumno.c]} > 0) \yLuego
        \\ (\exists i,j:\Z)(esAlumnoCercano(edr.Aula[i][j], alumno) \yLuego (\exists k:\Z)(alumno.examen[\norm{alumno.examen}][k]=="" \land edr.Aula[i][j].examen[\norm{examen}][k]\neq""))
