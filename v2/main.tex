...
\Tipo{}
    ...
    \requiereLargo{ 
        ...
        \\ edr = edr0 \yLuego
        \\ alumno.Cordenada.x = x0 \yLuego
        \\ alumno.Cordenada.y = y0 \yLuego
    ...
    \\ adyacente(<i, j>, alumno.Cordenada) \yLuego
    ...
    \\ \paraTodo p \Z{\paraTodo q \Z{cordenadaValida(p,q, edr0.Aula) \yLuego
    \\ (x0 \neq p \land y0 \neq q) \implicaLuego edr.Aula[p][q] = edr0.Aula[p][q]}} \yLuego
    % el resto esta igual
...
\predLargo{perteneceAlumno}{e:alumno, a:Aula}{
    ...
    \\ alumno.Cordenada.x = i \land alumno.Cordenada.y = j \yLuego
