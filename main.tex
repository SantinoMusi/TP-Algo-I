...
\predLargo{examenesInicializados}{a: Aula, sol: Examen}{
    \paraTodo{c1}{Coordenada}{(coordenadaValida(c1, a) \yLuego a[c1.f][c1.c].examen \neq \langle \rangle) \implicaLuego 
...
\predLargo{perteneceAlumno}{e: Alumno, a:Aula}{
    (coordenadaValida(e.coord, a) \yLuego a[e.coord.f][e.coord.c].examen \neq \langle \rangle \yLuego\\
...
\Inout edr: EdR
    ...
    \aseguraLargo{
        ...
        \\ (edr.aula[a.coord.f][a.coord.c].examen = \langle \rangle) \yLuego
...
\predLargo{todosEntregaron}{edr: EdR}{
    ...
    \\\paraTodo{c1}{Coordenada}{coordenadaValida(c1,edr.aula) \implicaLuego edr.aula[c1.f][c1.c].examen = \langle \rangle}
}
