...
\Inout edr: EdR
    ...
    \\\existe {seCopian}{\seq{Coordenada}}{\norm{seCopian} = n \land \\\paraTodo{c1}{Coordenada}{c1 \in seCopian \implica \\(coordenadaValida(c1,edr_0.aula) \yLuego 
    suExamen(c1, edr_0.aula) = \langle \rangle \land\\
...
\Tipo{\seq{tupla\tupla{Alumno, Nota}}}
    ...
    \aseguraLargo{
        ...
        \paraTodo{a}{Alumno}{(a \in edr.entregas \land \lnot (a \in edr.copiones)) \leftrightarrow\\
        tupla\tupla{a, nota(a, edr.solucion)} \in res\yLuego\\
        % me fijo que la tupla este una sola vez
        \paraTodo{i}{\Z}{0 \leq i < \norm{res} \implicaLuego
        \paraTodo{j}{\Z}{0 \leq j < \norm{res}\implicaLuego (res[i] = res[j] \implica i = j)}}}
